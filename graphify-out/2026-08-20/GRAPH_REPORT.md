...
## Corpus Check
- 216 files · ~4,570,534 words
- Verdict: corpus is large enough that graph structure adds value.

## Summary
- 1558 nodes · 1943 edges · 168 communities (122 shown, 46 thin omitted)
...
Cohesion: 0.18
Nodes (13): Blog(), buildRail(), CATEGORY_LABEL, HOME_SLUGS, LedeCard(), RailRow(), seat(), DarkZone() (+5 more)
...
Cohesion: 0.12
Nodes (14): jsonLd, metadata, CONTACT_LINKS, EASE, EXPLORE, FootLink, LEGAL, WORDMARK_FADE (+6 more)
...
Cohesion: 0.11
Nodes (17): AboutSplit(), DOOR_IN, DOOR_ROW, DOOR_WIPE, DOORS, DRAWER, DRIFT, EASE (+9 more)
...
### Community 101 - "q"
Cohesion: 0.08
Nodes (32): jsonLd, metadata, displayFace, metadata, textFace, jsonLd, metadata, ConsentControl() (+24 more)
...
Cohesion: 0.13
Nodes (20): BlogIndexInner(), buildFilters(), CardMedia(), navigate(), pageCountFor(), postsForPage(), queryListeners, ROOM_NAME (+12 more)
...
## Knowledge Gaps
- **730 isolated node(s):** `jsonLd`, `metadata`, `metadata`, `jsonLd`, `metadata` (+725 more)
...
- **Why does `SmoothScroll()` connect `press.ts` to `probe-timeline-contrast.mjs`, `CustomCursor.tsx`, `q`?**
