...
## Corpus Check
- 190 files · ~4,536,947 words
- Verdict: corpus is large enough that graph structure adds value.

## Summary
- 1428 nodes · 1726 edges · 151 communities (113 shown, 38 thin omitted)
- Extraction: 97% EXTRACTED · 3% INFERRED · 0% AMBIGUOUS · INFERRED: 45 edges (avg confidence: 0.67)
- Token cost: 0 input · 0 output

## Graph Freshness
- Built from commit: `190a333a`
...
Cohesion: 0.21
Nodes (9): VenueBlock(), VenueCard(), VenueCardProps, primaryAction(), Extras, VenueAddress, venueCard(), VenueCardItem (+1 more)
...
Cohesion: 0.13
Nodes (17): Film(), metadata, MenuOverlay(), EASE, MARKS, ORDER, PressWall(), RestaurantDetail() (+9 more)
...
Cohesion: 0.18
Nodes (11): FootLinkA(), CLIPS, Hero(), CURTAIN, IMAGES, Navigate, PageTransition(), Phase (+3 more)

### Community 84 - "restaurants.ts"
Cohesion: 0.12
Nodes (15): DOOR_IN, DOOR_ROW, DOOR_WIPE, DOORS, DRAWER, DRIFT, EASE, FADE (+7 more)
...
Cohesion: 0.13
Nodes (15): Contact(), ContactProps, ContactPage(), mapUrl(), VISITABLE, DarkZone(), CONTACT_LINKS, EASE (+7 more)
...
Cohesion: 0.31
Nodes (6): REVIEWABLE, reviewUrl(), ReviewUs(), Restaurant, RESTAURANTS, VenueAction
...
Cohesion: 0.20
Nodes (8): displayFace, metadata, textFace, GroupPressJsonLd(), OrganizationJsonLd(), orgSameAs, WebSiteJsonLd(), PRESS
...
### Community 117 - "PressWall.tsx"
Cohesion: 0.22
Nodes (10): generateMetadata(), RestaurantPage(), VenueMark(), VenueMark(), RestaurantJsonLd(), HIGHLIGHT_QUOTES, PRESS_INDEX, pressForRestaurant() (+2 more)
...
Cohesion: 0.14
Nodes (11): cellVariants, DiscoverDisplay, DiscoverItem, DISPLAY, EASE, EXPAND_SPRING, ExpandedCard(), ITEMS (+3 more)
...
Cohesion: 0.23
Nodes (7): AboutSplit(), HERO_INSETS, Reservations(), Clip, clipStyle(), useVisiblePlayback(), VideoBackdrop()

### Community 140 - "page.tsx"
Cohesion: 0.33
Nodes (4): jsonLd, metadata, JobOpening, JOBS

### Community 141 - "GlassFilters.tsx"
Cohesion: 0.29
...
Cohesion: 0.12
Nodes (19): clamp01(), DIAL_CODES, DIGITS, FlipDigit(), HERO_LINES, inkBox(), INTRO_ENDS_AT, JoinUs() (+11 more)

## Knowledge Gaps
- **687 isolated node(s):** `jsonLd`, `metadata`, `metadata`, `jsonLd`, `metadata` (+682 more)
...
- **Why does `JoinUs()` connect `JoinUs.tsx` to `q`, `RestaurantsShowcase.tsx`?**
  _High betweenness centrality (0.030) - this node is a cross-community bridge._
- **Why does `SmoothScroll()` connect `package.json` to `JoinUs.tsx`, `probe-timeline-contrast.mjs`, `PressWall.tsx`?**
