...
## Corpus Check
- 197 files · ~4,540,175 words
- Verdict: corpus is large enough that graph structure adds value.

## Summary
- 1440 nodes · 1707 edges · 152 communities (117 shown, 35 thin omitted)
- Extraction: 97% EXTRACTED · 3% INFERRED · 0% AMBIGUOUS · INFERRED: 45 edges (avg confidence: 0.67)
- Token cost: 0 input · 0 output

## Graph Freshness
- Built from commit: `dc1dd8cc`
...
Cohesion: 0.12
Nodes (21): VenueMark(), VenueMark(), cellVariants, Discover(), DiscoverDisplay, DiscoverItem, DISPLAY, EASE (+13 more)
...
Cohesion: 0.14
Nodes (15): Film(), metadata, MenuOverlay(), EASE, MARKS, ORDER, PressWall(), asset() (+7 more)
...
Cohesion: 0.06
Nodes (34): CustomCursor(), Mode, CASES, centreOf(), diff(), frame(), layoutCost(), layoutCount() (+26 more)
...
Cohesion: 0.13
Nodes (12): metadata, CARDS, LOOP, MID, nameList(), project(), NOTE: one video ships today (hero-draft3). Drop a per-restaurant clip in, RESTAURANTS (+4 more)
...
Cohesion: 0.07
Nodes (32): AboutSplit(), DOOR_IN, DOOR_ROW, DOOR_WIPE, DOORS, DRAWER, DRIFT, EASE (+24 more)
...
Cohesion: 0.18
Nodes (10): ContactProps, CONTACT_LINKS, EASE, EXPLORE, FootLink, WORDMARK_FADE, WORDMARK_MASK, WORDMARK_RISE (+2 more)
...
Cohesion: 0.38
Nodes (5): Contact(), ContactPage(), mapUrl(), VISITABLE, DarkZone()
...
### Community 101 - "q"
Cohesion: 0.21
Nodes (7): GroupPressJsonLd(), orgSameAs, FEATURED_OUTLETS, HIGHLIGHT_QUOTES, PRESS, PRESS_INDEX, PressMention
...
Cohesion: 0.15
Nodes (10): displayFace, metadata, textFace, FILTERS, GlassFilters(), KEEP, LENS_MAP, PILL_MAP (+2 more)
...
## Knowledge Gaps
- **694 isolated node(s):** `jsonLd`, `metadata`, `metadata`, `jsonLd`, `metadata` (+689 more)
...
- **Why does `JoinUs()` connect `JoinUs.tsx` to `probe-timeline-contrast.mjs`, `RestaurantsShowcase.tsx`?**
  _High betweenness centrality (0.024) - this node is a cross-community bridge._
- **Why does `q()` connect `probe-timeline-contrast.mjs` to `JoinUs.tsx`, `press.ts`, `Discover.tsx`, `VideoBackdrop.tsx`?**
