# Graph Report - Maginhawa  (2026-08-28)

## Corpus Check
- 264 files · ~5,061,851 words
- Verdict: corpus is large enough that graph structure adds value.

## Summary
- 1837 nodes · 2324 edges · 206 communities (152 shown, 54 thin omitted)
- Extraction: 98% EXTRACTED · 2% INFERRED · 0% AMBIGUOUS · INFERRED: 49 edges (avg confidence: 0.67)
- Token cost: 0 input · 0 output

## Graph Freshness
- Built from commit: `f6db1a18`
...
Cohesion: 0.14
Nodes (17): CLIPS, Hero(), FootLinkA(), LINKS, Nav(), Theme, useLinksLeft(), CURTAIN (+9 more)
...
Cohesion: 0.27
Nodes (8): JournalPost(), ContactPage(), mapUrl(), VISITABLE, ITEMS, Menu(), getNavTheme(), DarkZone()
...
Cohesion: 0.09
Nodes (33): displayFace, metadata, textFace, GoogleTag(), Window, MarketingPixels(), Window, ConsentControl() (+25 more)
...
Cohesion: 0.06
Nodes (37): jsonLd, metadata, BlogPage(), metadata, generateMetadata(), generateStaticParams(), JournalPostPage(), jsonLd (+29 more)
...
Cohesion: 0.09
Nodes (32): BlogIndexInner(), buildFilters(), CardMedia(), navigate(), pageCountFor(), postsForPage(), queryListeners, ROOM_NAME (+24 more)
...
Cohesion: 0.27
Nodes (7): Blog(), buildChapter(), frame(), Spine(), SPINE_FOCAL, SpineItem, menuHref()
...
### Community 173 - "probe-timeline.mjs"
Cohesion: 0.22
...
Cohesion: 0.05
Nodes (27): jsonLd, metadata, clamp01(), DIAL_CODES, DIGITS, FlipDigit(), HERO_LINES, inkBox() (+19 more)
...
Cohesion: 0.38
Nodes (5): VenueBlock(), VenueCard(), VenueCardProps, primaryAction(), splitActions
...
- **Why does `JoinUs()` connect `JoinUs.tsx` to `probe-band-about-press.mjs`, `PageTransition.tsx`, `getRestaurant`?**
  _High betweenness centrality (0.051) - this node is a cross-community bridge._
- **Why does `q()` connect `getRestaurant` to `shoot`, `probe-passage-setting.mjs`, `probe-timeline.mjs`, `JoinUs.tsx`, `probe-timeline-contrast.mjs`, `press.ts`?**
