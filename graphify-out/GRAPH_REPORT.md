...
## Corpus Check
- 197 files · ~4,539,104 words
- Verdict: corpus is large enough that graph structure adds value.

## Summary
- 1442 nodes · 1733 edges · 149 communities (113 shown, 36 thin omitted)
...
Cohesion: 0.13
Nodes (20): generateMetadata(), RestaurantPage(), VenueMark(), VenueMark(), VenueBlock(), VenueCard(), VenueCardProps, RestaurantJsonLd() (+12 more)
...
Cohesion: 0.05
Nodes (32): jsonLd, metadata, jsonLd, metadata, jsonLd, metadata, About(), CHAPTERS (+24 more)
...
Cohesion: 0.18
Nodes (12): Film(), metadata, MenuOverlay(), RestaurantDetail(), asset(), AssetOptions, IMAGE_EXT, isRemote() (+4 more)
...
Cohesion: 0.06
Nodes (35): CustomCursor(), Mode, docTop(), CASES, centreOf(), diff(), frame(), layoutCost() (+27 more)
...
### Community 101 - "q"
Cohesion: 0.22
Nodes (8): EASE, MARKS, ORDER, PressWall(), FEATURED_OUTLETS, HIGHLIGHT_QUOTES, PRESS_INDEX, PressMention
...
Cohesion: 0.14
Nodes (11): Contact(), ContactProps, ContactPage(), mapUrl(), VISITABLE, ITEMS, Reveal(), RevealProps (+3 more)
...
Cohesion: 0.16
Nodes (11): clamp01(), DIAL_CODES, DIGITS, FlipDigit(), HERO_LINES, inkBox(), INTRO_ENDS_AT, JoinUs() (+3 more)
...
- **Why does `q()` connect `probe-timeline-contrast.mjs` to `JoinUs.tsx`, `press.ts`, `VideoBackdrop.tsx`?**
