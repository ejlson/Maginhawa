...
await p.screenshot({path:`${OUT}/disc3.png`});
// also a shorter viewport to confirm text stays on screen
await p.setViewport({width:1440,height:760});
await p.evaluate(()=>document.getElementById('restaurants').scrollIntoView());await s(800);
await p.screenshot({path:`${OUT}/disc3_short.png`});
